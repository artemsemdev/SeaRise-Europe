# Static-target supply-chain validation

The active Phase 2 supply-chain authority is
...
The command validates 45 exact inputs. It also regenerates and compares the
...
The v2 npm artifact is derived from a root lock with exactly one `src/web`
