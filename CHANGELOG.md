...
- Canonicalized GeoParquet Arrow schema metadata and Tippecanoe gzip platform
  markers so the Linux and macOS ARM64 release profiles produce identical
  analytical and visual artifact bytes without changing their values.
