...
`public-readback-verification-receipt.schema.json` records a later, bounded
HTTPS readback of the exact manifest and provenance subjects. The readback hook
